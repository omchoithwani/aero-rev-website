        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-3 mb-12">
              ...
              <li className="text-muted-foreground"><strong>Vary subject lines:</strong> Don't use the same subject for all 500 contacts. Use personalization tokens: <code>Quick question, {'{{contact.firstname}}'}</code></li>
